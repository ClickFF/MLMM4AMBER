...
#  endif /* LES */
  ...
  ! Update this when the version changes! (Also update the len if necessary.)
  ! Keep this line so grep finds this version stamp:  Amber22 Amber 22
  character (len=4), parameter :: VERSION_STRING = "22.0"
...
#include "../include/md.h"
  ...
  if (numgroup > 1) then
    ...
    if (worldrank == 0) then
      write(6, '(a)') ''
      write(6, '(a)') ' Running multisander version of sander Amber22'
